...
public interface EntregadorService {
	...
	public EntregadorResponseDTO criarEntregador(EntregadorRequestDTO entregadorRequestDTO)
			throws EntregadorAlreadyCreatedException, InvalidCodigoAcessoException;
	...
	public EntregadorRequestDTO atualizarEntregador(Long id, EntregadorRequestDTO entregadorRequestDTO)
			throws EntregadorNotFoundException;

	public EntregadorResponseDTO atualizarStatusDisponibilidade(Long id, EntregadorStatusRequestDTO entregadorRequestDTO)
			throws EntregadorNotFoundException, EntregadorNaoAprovadoException, IncorretCodigoAcessoException;
}